...
stdenv.mkDerivation {
  ...
  postFixup =
    ...
    '' + optionalString isIntel ''
        ccLDFlags+=" -L${cc}/lib64compilers_and_libraries_2019.1.144/linux/compiler/lib/intel64_lin/"
        ccCFlags+=" -B${cc}/compilers_and_libraries_2019.1.144/linux/compiler/lib/intel64_lin/"
    ''
